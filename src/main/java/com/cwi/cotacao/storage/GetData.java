...
public class GetData {
	...
	/*
	 * O método a baixo não é criação minha e sim uma implementação simples feita pelo usuário mcbrain 
	 * do guj no seginte link: http://www.guj.com.br/t/fazer-download-de-arquivo-com-java/114989/2
	 * Por ser uma implementação simples utilizando biblioteca nativa do Java.
	 */
